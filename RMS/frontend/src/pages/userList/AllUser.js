...
import tableStyle from "./AllUser.module.css";
...
const AllUser = ({ allOrders, column }) => {
  console.log(allOrders);
  const[userDataArray,setUserDataArray]=useState([{id:1,first_name: 'akki', last_name: 'jawale', country: 'india', age: '26'}])
  ...
  return (
    ...
    <div>
      <div class="px-2" id="title-size">User List</div>
