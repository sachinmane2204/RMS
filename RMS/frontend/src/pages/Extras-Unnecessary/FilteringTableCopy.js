...
export const FilteringTable = ({allOrders}) => {
  ...
  const[userDataArray,setUserDataArray]=useState([{id:1,first_name: 'akshay', last_name: 'jawale', country: 'india', age: '26'}])
  ...
  return (
    ...
    <div>
    <div classN="flist">
    <div class="px-2 mb-4" id="title-size"> List</div>
    
          <div class="px-4 mb-4" id='icon-size'> 
